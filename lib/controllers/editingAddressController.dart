...
class EditingAddressController with ChangeNotifier {
  ...
  final TextEditingController _addressTypeController = TextEditingController(text: "Shipping");
  ...
  Future<bool> updateAddress(String addressId) async {
    ...
    print("address id from controller ${addressId}");
  ...
  void init(
    ...
    _addressLineController.text = address.addressLine1!;
    _cityController.text = address.city!;
    _stateController.text = address.state!;
    _pinCodeController.text = address.postalCode!;
    _countryController.text = address.region!;
    _addressTypeController.text = address.addressType!;
    _gstNumberController.text = address.gstNumber!;
    _context = context;
